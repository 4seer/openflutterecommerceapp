...
class OpenFlutterProductCard extends StatelessWidget {
  ...
  const OpenFlutterProductCard({Key key, this.product, this.width, this.height})
      : super(key: key);
        ...
        Container(
          ...
          child: Column(
              ...
              children: <Widget>[
                ...
                Text(product.categoryTitle, style: _theme.textTheme.headline4),
                Text(product.title, style: _theme.textTheme.headline2),
