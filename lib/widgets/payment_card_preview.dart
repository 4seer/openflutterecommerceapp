...
class OpenFlutterPaymentCardPreview extends StatelessWidget {
  ...
  const OpenFlutterPaymentCardPreview({Key key, 
    @required this.width,
    @required this.cardNumber, 
    @required this.cardHolderName, 
    @required this.expirationMonth, 
    @required this.expirationYear, 
    this.cardType = CardType.MasterCard}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final ThemeData _theme = Theme.of(context);
    String asset = "assets/images/checkout/dark_card.png";
      ...
      child: Container(
        ...
        child: Stack(children: <Widget>[
          ...
          Positioned(
            ...
            width: width - AppSizes.sidePadding,
            height: 38,
            child: Text(expirationMonth.toString().padLeft(2, '0') + '/' + 
