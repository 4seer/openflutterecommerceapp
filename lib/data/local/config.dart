class OpenFlutterDatabaseConfig {
  ...
  static const createTablesQueries = [
    ...
    'CREATE TABLE IF NOT EXISTS ProductCategory(id INTEGER PRIMARY KEY, title TEXT, description TEXT, image TEXT, thumb TEXT, orderNumber INTEGER DEFAULT 0, count  INTEGER DEFAULT 0, parentId INTEGER DEFAULT 0)',
    ...
    'CREATE TABLE IF NOT EXISTS User(id INTEGER PRIMARY KEY, name TEXT, avatar TEXT, email TEXT, password TEXT, token TEXT, birthDate NUMERIC, salesNotification NUMERIC, newArrivalsNotification NUMERIC, deliveryStatusChanges NUMERIC)',
    ...
    'CREATE TABLE IF NOT EXISTS PromoCode(id INTEGER PRIMARY KEY, title TEXT, image TEXT, promoCode TEXT, discountPercent INTEGER, belongsToUser NUMERIC, wasUsed NUMERIC)',
