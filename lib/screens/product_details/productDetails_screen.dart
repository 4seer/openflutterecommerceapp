...
//                  ),
        ...
        builder: (BuildContext context) => Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: IgnorePointer(
                      child: GridView.count(
                          ...
                          children: _sizes.map((String value) => GestureDetector(
                            onTap: ()=>print(value),
                            child: new Container(
                  ...
                  Theme(data:Theme.of(context).copyWith(dividerColor: AppColors.darkGray), child: Divider()),
                  ExpansionTile(title: Text("Size info"),trailing: Icon(Icons.keyboard_arrow_right),),
                  Theme(data:Theme.of(context).copyWith(dividerColor: AppColors.darkGray), child: Divider()),
                  SizedBox(
                    height: 10.0,
                  ),
                  Center(
                    child: OpenFlutterButton(title: "ADD TO CART", onPressed: null,),
                  )
                ],
              ),
            )
  ...
  _showSelectColorBottomSheet(BuildContext context)  //modelBottomSheet for selecting color
  {
    showModalBottomSheet(
        context: context,
        shape: RoundedRectangleBorder(
              ...
              Container(
                ...
                child: IgnorePointer(
                  child: GridView.count(
                    ...
                    crossAxisCount: 3,
                    childAspectRatio: 100/60,
                    children: _color.map((String value) => GestureDetector(
                      onTap: ()=>print(value),
                      child: new Container(
                        margin: EdgeInsets.all(10.0),
                        decoration: BoxDecoration(
  ...
  Widget selectionOutlineButton(var deviceWidth,String title,Function fun) { //select size and select color widget
  ...
  Widget productDetails(ThemeData theme) {  //title,rating,price of product
