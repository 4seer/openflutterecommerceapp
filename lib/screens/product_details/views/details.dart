...
class ProductDetailsView extends StatefulWidget {
  ...
  const ProductDetailsView({Key key, 
    ...
    @required this.similarProducts}) : super(key: key);
...
class _ProductDetailsViewState extends State<ProductDetailsView> {
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            selectionOutlineButton(
                                deviceWidth, "Size", _showSelectSizeBottomSheet, bloc),
                            selectionOutlineButton(
                                deviceWidth, "Color", _showSelectColorBottomSheet, bloc),
  ...
  _showSelectColorBottomSheet(
      BuildContext context, ProductBloc bloc) //modelBottomSheet for selecting color
  {
    showModalBottomSheet(
      context: context,
      shape: RoundedRectangleBorder(
  ...
  Widget selectionOutlineButton(var deviceWidth, String title, Function fun, ProductBloc bloc) {
