...
class MyOrderDetailsView extends StatefulWidget {
  ...
  const MyOrderDetailsView({Key key, 
    @required this.changeView}) : super(key: key);
                ...
                children: <Widget>[
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        DateFormat('yyyy-MM-dd').format(state.orderData.orderDate),
                  ...
                  buildSummaryLine('Shipping Address:', 
                    state.orderData.shippingAddress.toString(), _theme ,width),
                  SizedBox(
                    height: AppSizes.sidePadding,
                  ),
                  ...
                  buildSummaryLine('Discount:', 
                    state.orderData.promo.toString(), 
                    _theme ,width),
                  SizedBox(
                    height: AppSizes.sidePadding,
                  ),
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      Padding(padding: EdgeInsets.only(left: AppSizes.sidePadding),),
                      OpenFlutterButton(
                        height: 36,
                        width: (width - AppSizes.sidePadding*3)/2,
